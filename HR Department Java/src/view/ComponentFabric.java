...
public class ComponentFabric {
    ...
    public <T> Component build(int type, Service<Departments> service , Service<Employees> service1) {
        try {
            ...
            return components.computeIfAbsent(componentType, (ct) -> {
                ...
                switch (ct) {
                    ...
                    case UPDATE_BOX:
                        ...
                        break;
                    case LIST_EMPLOY:
                         component = new ObjectsListComponent<Employees>(service1);
                        break;
                    case SINGLE_EMPLOY:
                        component = new SingleObjectComponent<Employees>(service1);
                        break;
                    case CREATE_EMPLOY:
